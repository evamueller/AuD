...
public class ListeGUI extends Frame
{
	...
	//Leere Liste anlegen
	private Liste eineListe = new Liste();
	private ListeCanvas eineZeichenflaeche; //Zeichenfläche für die Animation
	...
	public ListeGUI()
	{
		...
		ruecksetzenDruckknopf.setLabel("Rücksetzen");
		...
		Liste zweiteListe = new Liste(); //Leere Liste mit 2 Leerelementen anlegen
	...
	class AktionsAbhoerer implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			if (o == suchenDruckknopf)
			{
				...
				{
					int m = (Integer.valueOf(elementTextfeld.getText()).intValue());
					eineListe.suchenElement(Integer.valueOf(elementTextfeld.getText()));
				}
				catch (NumberFormatException e)
				{
					meldungsTextbereich.setText(e.getMessage());
			...
			if (o == traversierenDruckknopf)
			{
				...
				Iterator e = eineListe.iterator();
				while (e.hasNext())
					ausgabeTextbereich.append((Integer)e.next() + " ");
